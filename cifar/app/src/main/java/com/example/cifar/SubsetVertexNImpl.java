 ...
 * @author Alex Black
 */
public class SubsetVertexNImpl extends BaseGraphVertex {
    private int from;
    private int to; //inclusive
    private long[] forwardShape;

    public SubsetVertexNImpl(ComputationGraph graph, String name, int vertexIndex, int from, int to, DataType dataType) {
        this(graph, name, vertexIndex, null, null, from, to, dataType);
    }

    public SubsetVertexNImpl(ComputationGraph graph, String name, int vertexIndex, VertexIndices[] inputVertices,
