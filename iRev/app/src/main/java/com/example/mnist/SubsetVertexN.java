...
public class SubsetVertexN extends GraphVertex {
     ...
     */
    public SubsetVertexN(@JsonProperty("from") int from, @JsonProperty("to") int to) {
        this.from = from;
        this.to = to;
    }

    @Override
    public SubsetVertexN clone() {
        return new SubsetVertexN(from, to);
    }

    @Override
    public boolean equals(Object o) {
        if (!(o instanceof SubsetVertexN))
            return false;
        SubsetVertexN s = (SubsetVertexN) o;
    ...
    public MemoryReport getMemoryReport(InputType... inputTypes) {
        ...
        return new LayerMemoryReport.Builder(null, SubsetVertexN.class, inputTypes[0], outputType).standardMemory(0, 0) //No params
