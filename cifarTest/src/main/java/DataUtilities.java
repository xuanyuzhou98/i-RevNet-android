...
public class DataUtilities {
    protected static final org.slf4j.Logger log = LoggerFactory.getLogger(DataUtilities.class);
    ...
    public static boolean downloadFile(String remoteUrl, String localPath) throws IOException {
        ...
        if (!file.exists()) {
            ...
            log.info("load data"+ file.getParentFile().getAbsolutePath());
            boolean exist = file.getParentFile().exists();
            log.info("load data"+ "exist"+exist);
